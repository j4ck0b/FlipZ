...
export const translations = {
  pl: {
    ...
    sports: "Sporty",
    other: "Inne",
    mint: "Stan idealny (Mint)",
    nearMint: "Prawie idealny (Near Mint)",
    excellent: "Doskonały (Excellent)",
    good: "Dobry (Good)",
    fair: "Przeciętny (Fair)",
    poor: "Słaby (Poor)",
    common: "Pospolita (Common)",
    uncommon: "Niepospolita (Uncommon)",
    rare: "Rzadka (Rare)",
    ultraRare: "Ultra Rzadka (Ultra Rare)",
    legendary: "Legendarna (Legendary)",
